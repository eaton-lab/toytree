...
Jupyter notebooks
-----------------
If you are not familiar with jupyter-notebooks the best way to get started is to give one a try. You can try out toytree running in the cloud: `binder <http://mybinder.org:/repo/eaton-lab/toytree>`__. 
