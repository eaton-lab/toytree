...
class NodeAssist:
    ...
    def match_reciprocal(self):
        """
        Returns the set of taxa that does not include the select set.
        """
    ...
    def get_mrca(self):
        """
        Returns the TreeNode that is mrca of the selected set.
        """
        if len(self.nodes) > 1:
    ...
    def is_query_monophyletic(self):
        """
        returns True if query set is monophyletic
        """
